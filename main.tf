...
# create s3 bucket 
module "s3_bucket" {
  source               = "git@github.com:chidex-henry/Terraform-modules.git//s3"
  project_name         = local.project_name
...
module "ecs_task_execution" {
  source               = "git@github.com:chidex-henry/Terraform-modules.git//ecs-iam-role"
  project_name         = local.project_name
  environment          = local.environment
...
module "ecs" {
  source                       = "git@github.com:chidex-henry/Terraform-modules.git//ecs"
  project_name                 = local.project_name
  environment                  = local.environment
  ecs_task_execution_role_arn  = module.ecs_task_execution.ecs_task_execution_role_arn
...
# create aut scaling group
module "ecs_asg" {
  source       = "git@github.com:chidex-henry/Terraform-modules.git//asg-ecs"
  project_name = local.project_name
  environment  = local.environment
